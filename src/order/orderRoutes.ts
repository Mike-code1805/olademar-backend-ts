...
import { createOneOrderController } from './controllers';

const orderRouter: Router = Router();

orderRouter.route('/api/order').post(authUserTokenValidation, createOneOrderController).get(authTokenValidationAndIsAdmin, getOrders);
